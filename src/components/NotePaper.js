    ...
    return (
        <Box
            sx={{
                ...
                position: "relative",
                backgroundImage: "radial-gradient(white 21%, transparent 21%), radial-gradient(transparent 10%, transparent 12%), linear-gradient(to top, hsla(0,0%,0%,0) 0%, hsla(0,0%,0%,0) 95%, hsla(180,25%,50%,.2) 95%, hsla(180,25%,50%,.2) 100%)",
